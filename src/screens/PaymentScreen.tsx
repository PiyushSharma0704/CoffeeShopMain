              ...
              <View style={styles.creditCardBG}>
                ...
                >
                  ...
                  <View style={styles.creditCardNumberContainer}>
                    <Text style={styles.creditCardNumber}>3379</Text>
                    <Text style={styles.creditCardNumber}>8797</Text>
                    <Text style={styles.creditCardNumber}>6476</Text>
                    <Text style={styles.creditCardNumber}>3498</Text>
                  </View>
                  <View style={styles.creditCardRow}>
                    <View style={styles.creditCardNameContainer}>
                      <Text style={styles.creditCardNameSubTitle}>Card Holder Name</Text>
                      <Text style={styles.creditCardNameTitle}>Umang Gupta</Text>
                    </View>
